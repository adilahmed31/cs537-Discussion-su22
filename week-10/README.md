...
![alt text](https://raw.githubusercontent.com/adilahmed31/cs537-Discussion-su22/main/week-10/pics/dir_entry.png)
...
## Reading Disk Image
Now, how can one reach inodes? Using starter code. We suggest reading [runscan.c](https://github.com/adilahmed31/cs537-Discussion-su22/blob/main/week-10/runscan.c) before starting P5. This file shows how to browse through disk image and iterate over inodes using the read_inode function inside read_ext2.c. First off, we'll look at the read_inode function and observe what argument it takes and what it returns.
